...
export function listaPrestamos() {
    ...
    arrayPrestamos.forEach(prestamo => {
        ...
        li1.innerHTML="Id="+prestamo.id + " - " +"Titulo= "+ prestamo.titulo;
...
export function listaSocios() {
    ...
    arraySocios.forEach(socio => {
        let li1 = document.createElement('li'); 
        li1.innerHTML="Id="+socio.idSocio + " - " +"Nombre= "+ socio.nombre+" - " +"Correo= "+ socio.mail;
        li1.className = "list-group-item";
        ul.appendChild(li1);
    });
